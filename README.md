...
1. Tela de Home/Feed
Exibe os itens disponíveis para doação, como roupas, móveis e bicicletas. O usuário pode navegar pelas opções ou aplicar filtros.

2. Tela de Filtros
Permite refinar a busca por categoria (ex: roupas, móveis), estado do item (novo, semi-novo, usado) e outros critérios.

3. Tela de Detalhes do Item
Mostra informações completas do produto, como descrição, estado e imagens. A partir daqui, o usuário pode demonstrar interesse e iniciar uma conversa.

4. Tela de Chat
Espaço de comunicação entre doador e interessado. Permite tirar dúvidas e combinar retirada do item.

5. Tela de Cadastro de Item
Onde o usuário pode cadastrar um novo item para doação, inserindo título, descrição, categoria e imagens.

6. Tela de Perfil
Apresenta informações do usuário, histórico de itens doados e selos/conquistas obtidas por doações realizadas.
